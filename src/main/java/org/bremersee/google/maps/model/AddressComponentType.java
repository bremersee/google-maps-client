...
/**
 * The Address Component types. Please see <a href="https://developers.google.com/maps/documentation/geocoding/intro#Types">Address
...
public enum AddressComponentType {
  ...
  public static AddressComponentType fromValue(String value) {
    for (final AddressComponentType type : AddressComponentType.values()) {
      if (type.addressComponentType.equalsIgnoreCase(value)) {
        return type;
      }
    }
    return null;
